...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="https://jidescms.herokuapp.com/users/login.php">Login</a>
                    </li>
                    <li>
                        <a href="https://jidescms.herokuapp.com/registration.php">Registration</a>
                    </li>
                    <!-- <li>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; <a href="">Ayeni Babajide</a> | Complaint Management System 2020</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
